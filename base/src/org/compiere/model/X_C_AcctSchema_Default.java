...
public class X_C_AcctSchema_Default extends PO implements I_C_AcctSchema_Default, I_Persistent 
{
	...
	public I_C_ValidCombination getgeneral_reserve_funds_A() throws RuntimeException
    {
		return (I_C_ValidCombination)MTable.get(getCtx(), I_C_ValidCombination.Table_Name)
			.getPO(getgeneral_reserve_funds_Acct(), get_TrxName());	}

	/** Set general Reserve Funds A/C.
		@param general_reserve_funds_Acct general Reserve Funds A/C	  */
	public void setgeneral_reserve_funds_Acct (int general_reserve_funds_Acct)
	{
		set_Value (COLUMNNAME_general_reserve_funds_Acct, Integer.valueOf(general_reserve_funds_Acct));
	}

	/** Get general Reserve Funds A/C.
		@return general Reserve Funds A/C	  */
	public int getgeneral_reserve_funds_Acct () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_general_reserve_funds_Acct);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
	...
	public I_C_ValidCombination getP_Liability_A() throws RuntimeException
    {
		return (I_C_ValidCombination)MTable.get(getCtx(), I_C_ValidCombination.Table_Name)
			.getPO(getP_Liability_Acct(), get_TrxName());	}

	/** Set Product Liabiliry.
		@param P_Liability_Acct Product Liabiliry	  */
	public void setP_Liability_Acct (int P_Liability_Acct)
	{
		set_Value (COLUMNNAME_P_Liability_Acct, Integer.valueOf(P_Liability_Acct));
	}

	/** Get Product Liabiliry.
		@return Product Liabiliry	  */
	public int getP_Liability_Acct () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_P_Liability_Acct);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
	...
	public I_C_ValidCombination getstatutory_reserve_fund_A() throws RuntimeException
    {
		return (I_C_ValidCombination)MTable.get(getCtx(), I_C_ValidCombination.Table_Name)
			.getPO(getstatutory_reserve_fund_Acct(), get_TrxName());	}

	/** Set Statutory Reserve Fund A/C.
		@param statutory_reserve_fund_Acct Statutory Reserve Fund A/C	  */
	public void setstatutory_reserve_fund_Acct (int statutory_reserve_fund_Acct)
	{
		set_Value (COLUMNNAME_statutory_reserve_fund_Acct, Integer.valueOf(statutory_reserve_fund_Acct));
	}

	/** Get Statutory Reserve Fund A/C.
		@return Statutory Reserve Fund A/C	  */
	public int getstatutory_reserve_fund_Acct () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_statutory_reserve_fund_Acct);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
