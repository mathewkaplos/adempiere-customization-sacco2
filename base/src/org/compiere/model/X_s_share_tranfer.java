...
// N
			setProcessed (false);
// N
			sets_member_receiver_ID (0);
			sets_member_sender_ID (0);
			sets_membershares_receiver_ID (0);
			sets_membershares_sender_ID (0);
			sets_share_tranfer_ID (0);
			sets_sharetype_receiver_ID (0);
			sets_sharetype_sender_ID (0);
...
// @Date@
	...
	/** Set Transferable Amount.
		@param tranferable_amount Transferable Amount	  */
	public void settranferable_amount (BigDecimal tranferable_amount)
	{
		set_Value (COLUMNNAME_tranferable_amount, tranferable_amount);
	}
	...
	{
		BigDecimal bd = (BigDecimal)get_Value(COLUMNNAME_tranferable_amount);
		if (bd == null)
			 return Env.ZERO;
		return bd;
	}
