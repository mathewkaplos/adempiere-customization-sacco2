...
// N
	...
	public org.compiere.model.I_C_ElementValue getcontra_account() throws RuntimeException
    {
		return (org.compiere.model.I_C_ElementValue)MTable.get(getCtx(), org.compiere.model.I_C_ElementValue.Table_Name)
			.getPO(getcontra_account_id(), get_TrxName());	}

	/** Set Contra Account.
		@param contra_account_id Contra Account	  */
	public void setcontra_account_id (int contra_account_id)
	{
		set_Value (COLUMNNAME_contra_account_id, Integer.valueOf(contra_account_id));
	}

	/** Get Contra Account.
		@return Contra Account	  */
	public int getcontra_account_id () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_contra_account_id);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
