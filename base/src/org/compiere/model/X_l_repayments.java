...
// N
	...
	/** Get Last Pay Date.
		@return (select last_pay_date from adempiere.s_loans s where s.s_loans_ID = l_repayments.s_loans_ID)
	  */
	...
	/** Set PRINT A4.
		@param print_a4 PRINT A4	  */
	public void setprint_a4 (String print_a4)
	{
		set_Value (COLUMNNAME_print_a4, print_a4);
	}
	...
	{
		return (String)get_Value(COLUMNNAME_print_a4);
	}

	/** Set PRINT RECEIPT.
		@param print_receipt PRINT RECEIPT	  */
	public void setprint_receipt (String print_receipt)
	{
		set_Value (COLUMNNAME_print_receipt, print_receipt);
	}
	...
	{
		return (String)get_Value(COLUMNNAME_print_receipt);
	}
