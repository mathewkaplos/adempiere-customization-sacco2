...
/** Generated Model for s_accReceivables
 *  @author Adempiere (generated) 
 *  @version Release 3.8.0 - $Id$ */
public class X_s_accReceivables extends PO implements I_s_accReceivables, I_Persistent 
{
    ...
    public X_s_accReceivables (Properties ctx, int s_accReceivables_ID, String trxName)
    {
      super (ctx, s_accReceivables_ID, trxName);
      /** if (s_accReceivables_ID == 0)
        {
			sets_accReceivables_ID (0);
        } */
    }

    /** Load Constructor */
    public X_s_accReceivables (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_s_accReceivables[")
	...
	/** Set s_accReceivables ID.
		@param s_accReceivables_ID s_accReceivables ID	  */
	public void sets_accReceivables_ID (int s_accReceivables_ID)
	{
		if (s_accReceivables_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_s_accReceivables_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_s_accReceivables_ID, Integer.valueOf(s_accReceivables_ID));
	}

	/** Get s_accReceivables ID.
		@return s_accReceivables ID	  */
	public int gets_accReceivables_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_s_accReceivables_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
    ...
    {
		return (I_s_bank)MTable.get(getCtx(), I_s_bank.Table_Name)
			.getPO(gets_bank_ID(), get_TrxName());	}
	...
	public org.compiere.model.I_C_Period gettransper() throws RuntimeException
    {
		return (org.compiere.model.I_C_Period)MTable.get(getCtx(), org.compiere.model.I_C_Period.Table_Name)
			.getPO(gettransperiod(), get_TrxName());	}
